...
4:icon20
  ...
  return (
    <div className="w-[1200px] m-auto bg-black">
       {/* --- BO'LIM 1 --- */}
      <div className='h-[800px]  border-gray-700 bg-gradient-to-br from-blue-950 to-black pt-20'>
        ...
        <div className='w-full flex flex-wrap gap-4 justify-center'>
          {
            box1.map((value) => {
              return (
                <div
                  key={value.id}
                  className="relative w-[280px] h-[280px] bg-gray-600/30 p-4 rounded-xl shadow-md border-gray-500 border-[0.2px] 
...
<h1 className='text-[20px] text-white font-bold mx-10 group-hover:text-red-400/80 duration-400'>David Kim</h1>
  ...
  {/* --- BO'LIM 6 --- */}
  <div className='h-[800px] border-b-[1px] border-gray-700 bg-gradient-to-br from-black to-black pt-20'>
    
        <div className='w-[1000px] h-[500px] border-[0.5px] border-gray-700  bg-gray-400/15 m-auto rounded-[10px]'>
        <div className='w-[200px] m-auto h-[30px] border-[0.5px] border-red-400 my-14 rounded-2xl bg-red-900/20'>
            <h1 className='text-center text-red-300 my-0.5 text-[14px]'>Our Impact in Numbers</h1>
          </div>
          <h1 className='text-4xl text-center mt-[20px] text-white font-bold'>Delivering Results That Matter</h1>
          
          <div className='w-[980px] mt-10 h-[250px] flex justify-evenly m-auto gap-10'>
            <div className='w-[200px] h-[200px] mx-1  group' >
              <img className='w-[40px] m-auto duration-1200 transform-content group-hover:translate-y-[-10px]' src={icon13} alt="" />
              <h1 className='text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-700 mx-5 text-[60px]  duration-100 font-bold transform-all group-hover:scale-110'>150+</h1>
              <h1 className='text-[20px] mx-3 text-gray-500'>Projects Delivered</h1>
            </div>
            <div className='w-[200px] h-[200px] group' >
              <img className='w-[40px] m-auto duration-1200 transform-content group-hover:translate-y-[-10px]' src={icon21} alt="" />
              <h1 className='text-transparent text-center bg-clip-text bg-gradient-to-r from-green-400 to-green-700 mx-7 text-[60px]  duration-100 font-bold transform-all group-hover:scale-110'>50+</h1>
              <h1 className='text-[20px] mx-8 text-gray-500'>Happy Clients</h1>
            </div>
            <div className='w-[230px] h-[200px]  group' >
              <img className='w-[40px] m-auto duration-1200 transform-content group-hover:translate-y-[-10px]' src={icon15} alt="" />
              <h1 className='text-transparent bg-clip-text bg-gradient-to-r from-yellow-600 to-yellow-700 mx-7 text-[60px]  duration-100 font-bold transform-all group-hover:scale-110'>99.9%</h1>
              <h1 className='text-[20px] mx-9 text-gray-500'>Support Available</h1>
            </div>
            <div className='w-[250px] h-[200px]  group' >
              <img className='w-[40px] m-auto duration-1200 transform-content group-hover:translate-y-[-10px]' src={icon16} alt="" />
              <h1 className='text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-700 mx-15 text-[60px]  duration-100 font-bold transform-all group-hover:scale-110'>24/7</h1>
              <h1 className='text-[20px] mx-11 text-gray-500'>Support Available</h1>
            </div>
          </div>
        </div>
